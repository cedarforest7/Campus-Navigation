...
public class TestGraphBuilding {
    ...
    private static final String OSM_DB_PATH = "../library-sp18/data/berkeley-2018.osm.xml";     //small tp be deleted
...
//        //test
//        for (long x : graphSmall.vertices()) {
//            System.out.println(x);
//        }
//        for (GraphDB.edge e : graphSmall.getEdge(4676767183L)) {
